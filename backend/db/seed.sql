...
INSERT INTO holding (user_id, commodity_id, quantity) VALUES
...
INSERT INTO trade_order (commodity_id, user_id, side, quantity, price) VALUES
  (1, 1, 'buy', 10, 10),  (1, 1, 'buy', 10, 11),  (1, 1, 'buy', 10, 12),
  (1, 2, 'sell', 10, 14), (1, 2, 'sell', 10, 15), (1, 2, 'sell', 10, 16),

  (2, 1, 'buy', 10, 10),  (2, 1, 'buy', 10, 11),  (2, 1, 'buy', 10, 12),
  (2, 2, 'sell', 10, 14), (2, 2, 'sell', 10, 15), (2, 2, 'sell', 10, 16),

  (3, 1, 'buy', 10, 10),  (3, 1, 'buy', 10, 11),  (3, 1, 'buy', 10, 12),
  (3, 2, 'sell', 10, 14), (3, 2, 'sell', 10, 15), (3, 2, 'sell', 10, 16);
